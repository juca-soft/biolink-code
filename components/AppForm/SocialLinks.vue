<template>
  <base-form-section
    title="Rede social"
    description="Conecte as suas redes sociais."
  >
    <div class="shadow sm:overflow-hidden sm:rounded-md">
      <div class="grid grid-cols-2 gap-8 bg-white px-4 py-5 sm:p-6">
        <p class="center">É necessario colocar o link completo do seu perfil.</p>
        <br>        
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              placeholder="https://fb.com/josuejuca"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://twitter.com/ojosuejuca"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://instagram.com/ojosuejuca"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://github.com/josuejuca"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://t.me/josuejuca"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://linkedin.com/josuejuca"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="biolink@josuejuca.com"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://youtube.com/josuejuca"
            />
          </div>
        </div>
        <div>
